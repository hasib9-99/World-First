                ...
                <div className='flex flex-col md:flex-row text-white justify-between w-full gap-6'>
                    <div className='w-full md:w-8/12'>
                        <div className='flex flex-row flex-wrap items-center justify-start gap-3'>
                            <a href="/"><img className='w-[140px] block' src={footerImageOne} alt="logo" type='webp' /></a>
                            <div className='flex flex-row flex-wrap items-center justify-start gap-3'>
                        ...
                        <div className='flex items-center justify-start gap-4 my-4'>
                            <a href="https://projects.assuredefi.com/project/me3"><img className='h-10' src={footerImageTwo} alt="footer-img-one" type='svg' /></a>
